...
const languages = ["Java", "JavaScript", "jQuery", "HTML/CSS"];
   
export default function Biocompace() {

    return (
        <ProjectPortfolio title="Biocompace" link="https://github.com/ekoranda/biocompace-request" images={list} languages={languages} desc={details}/>
